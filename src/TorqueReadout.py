...
controller_address, have_controller_address = \
	controller.find_address_of_controller(display, "/dev/input/")
...
threads = []
controller_thread = \
	threading.Thread(target=controller.read_button_input,args=(controller_command_queue, controller))
